...
public class Popular extends NavigationViewActivity implements MovieContract {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View contentView = inflater.inflate(R.layout.activity_popular, null, false);
        frameLayout = drawerLayout.findViewById(R.id.frame_layout_holder);
        popularRecyclerView = contentView.findViewById(R.id.popular_recycler_view);
        ...
        if (head_title != null) {
            ...
            title.setText(getResources().getString(R.string.popular));
        }
        searchIcon.setVisibility(View.VISIBLE);
        popularRecyclerView.setLayoutManager(new GridLayoutManager(context, 2, GridLayoutManager.VERTICAL, false));

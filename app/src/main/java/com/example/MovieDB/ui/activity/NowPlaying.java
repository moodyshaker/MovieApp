...
public class NowPlaying extends NavigationViewActivity implements MovieContract {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View contentView = inflater.inflate(R.layout.now_playing, null, false);
        frameLayout = drawerLayout.findViewById(R.id.frame_layout_holder);
        nowPlayingRecyclerView = contentView.findViewById(R.id.now_playing_recycler_view);
        ...
        nowPlayingRecyclerView.setLayoutManager(new GridLayoutManager(context, 2, GridLayoutManager.VERTICAL, false));
